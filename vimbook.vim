...
nnoremap <silent> ,0022 :!clear && ~/lab/checkStockPriceFor002299.sh
noremap <silent> ,s :let @/ = ""
noremap ,g :Tagbar
...
nnoremap <silent> WW :!clear && python3 ~/lab/getWeatherForXiamen.py
...
imap  <Plug>Isurround
inoremap  <Nop>
inoremap <silent> ,0022  :!clear && ~/lab/checkStockPriceFor002299.sh
inoremap <silent> WW  :!clear && python3 ~/lab/getWeatherForXiamen.pya
inoremap jk l
let &cpo=s:cpo_save
unlet s:cpo_save
set autoindent
...
set shortmess=aoO
badd +0 getWeatherForXiamen.py
args getWeatherForXiamen.py
edit getWeatherForXiamen.py
...
exe '1resize ' . ((&lines * 7 + 12) / 24)
exe 'vert 1resize ' . ((&columns * 40 + 40) / 80)
exe '2resize ' . ((&lines * 7 + 12) / 24)
exe 'vert 2resize ' . ((&columns * 39 + 40) / 80)
exe '3resize ' . ((&lines * 14 + 12) / 24)
argglobal
let s:cpo_save=&cpo
set cpo&vim
